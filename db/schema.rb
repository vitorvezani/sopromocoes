...
ActiveRecord::Schema.define(version: 20160330215521) do
  ...
  add_index "categories", ["text", "parent_id"], name: "index_categories_on_text_and_parent_id", unique: true, using: :btree
